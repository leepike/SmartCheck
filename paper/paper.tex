...
\emph{stackoverflow} asking about how to shrinking large nested data
...
enormous, requiring between 150 to 200 console output lines. \todo{redo tests}

Using SmartCheck, we are able to reduce counterexamples to around 25 lines of
output.  Most of the savings in the counterexample size were due to universal
generalization, like in the Xmonad case: entire record fields are abstracted
away.

``Retro-fitting'' SmartCheck to GenI, which is a large software system, requires
