...
\todo{violates sum-type hypothesis but cheap---not testing generated values,
  just direct subvalues.  Call this the sub-value hypothesis: direct sub-values
  of a counterexample may also be a counterexample.}
